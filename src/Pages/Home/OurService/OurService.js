...
const OurService = () => {
    return (
        <section className="py-6 bg-gray-800 text-gray-50 my-8 rounded">
                <div className="container mx-auto flex flex-col justify-around p-4 text-center md:p-10 lg:flex-row">
                    <div className="flex flex-col justify-center lg:text-left">
                        <p className="mb-1 text-sm font-medium tracking-widest uppercase text-violet-400">50% Off</p>
                        <h1 className="py-2 text-3xl font-medium leading-tight title-font">Find new and used Tesla cars.</h1>
                    </div>
